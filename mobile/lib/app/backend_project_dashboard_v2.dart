...
class BackendProjectDashboardScreenV2 extends StatefulWidget {
  ...
  @override
  State<BackendProjectDashboardScreenV2> createState() =>
      _BackendProjectDashboardScreenV2State();
}

class _BackendProjectDashboardScreenV2State
    extends State<BackendProjectDashboardScreenV2> {
      ...
      body: FutureBuilder<ProjectDashboardDataV2>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return BackendDashboardErrorV2(
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                DashboardSectionHeaderV2(
                  title: 'Expenses',
                  count: data.expenses.length,
                ),
                if (data.expenses.isEmpty)
                  const DashboardEmptyLineV2('No expenses yet')
                else
                  ...data.expenses.map(
                    (item) => BackendExpenseTileV2(item: item),
                  ),
                const SizedBox(height: 20),
                DashboardSectionHeaderV2(
                  title: 'Daily reports',
                ...
                if (data.reports.isEmpty)
                  const DashboardEmptyLineV2('No reports yet')
                else
                  ...data.reports.map(
                    (item) => BackendReportTileV2(item: item),
                  ),
                const SizedBox(height: 20),
                DashboardSectionHeaderV2(
                  title: 'Tasks',
                ...
                if (data.tasks.isEmpty)
                  const DashboardEmptyLineV2('No tasks yet')
                else
                  ...data.tasks.map(
                    (item) => BackendTaskTileV2(
                      item: item,
                ...
                if (data.files.isEmpty)
                  const DashboardEmptyLineV2('No files yet')
                else
                  ...data.files.map(
                    (item) => BackendFileTileV2(
                      item: item,
  ...
  Future<void> _addExpense() async {
    final saved = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (_) => BackendExpenseFormScreenV2(
  ...
  Future<void> _addReport() async {
    final saved = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (_) => BackendReportFormScreenV2(
          projectId: widget.project.id,
  ...
  Future<void> _addTask() async {
    final saved = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (_) => BackendTaskFormScreenV2(
          projectId: widget.project.id,
  ...
  Future<void> _addFile() async {
    final saved = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (_) => BackendFileUploadScreenV2(
          projectId: widget.project.id,
  ...
  Future<void> _deleteFile(RemoteProjectFile file) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Text(
          'The file record for “${file.originalName}” will be removed from this project.',
        ),
        actions: [
          TextButton(
...
class BackendFileUploadScreenV2 extends StatefulWidget {
  const BackendFileUploadScreenV2({
  ...
  @override
  State<BackendFileUploadScreenV2> createState() =>
...
class BackendExpenseFormScreenV2 extends StatefulWidget {
  const BackendExpenseFormScreenV2({
    required this.projectId,
    required this.repository,
    super.key,
  });
  ...
  @override
  State<BackendExpenseFormScreenV2> createState() =>
      _BackendExpenseFormScreenV2State();
}

class _BackendExpenseFormScreenV2State
    extends State<BackendExpenseFormScreenV2> {
...
class BackendReportFormScreenV2 extends StatefulWidget {
  const BackendReportFormScreenV2({
    required this.projectId,
    required this.repository,
    super.key,
  });
  ...
  @override
  State<BackendReportFormScreenV2> createState() =>
...
class BackendTaskFormScreenV2 extends StatefulWidget {
  const BackendTaskFormScreenV2({
    required this.projectId,
    required this.repository,
    super.key,
  });
  ...
  @override
  State<BackendTaskFormScreenV2> createState() =>
...
class BackendExpenseTileV2 extends StatelessWidget {
  const BackendExpenseTileV2({required this.item, super.key});
...
class BackendReportTileV2 extends StatelessWidget {
  const BackendReportTileV2({required this.item, super.key});
...
class BackendTaskTileV2 extends StatelessWidget {
  const BackendTaskTileV2({
    required this.item,
...
class BackendFileTileV2 extends StatelessWidget {
  const BackendFileTileV2({
    required this.item,
...
class DashboardSummaryCardV2 extends StatelessWidget {
  const DashboardSummaryCardV2({
    required this.title,
    required this.value,
    super.key,
  });
...
class DashboardSectionHeaderV2 extends StatelessWidget {
  const DashboardSectionHeaderV2({
    required this.title,
    required this.count,
    super.key,
  });
...
class DashboardEmptyLineV2 extends StatelessWidget {
  const DashboardEmptyLineV2(this.message, {super.key});
...
class BackendDashboardErrorV2 extends StatelessWidget {
  const BackendDashboardErrorV2({
