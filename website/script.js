...
const demoContent = {
  object: {
    number: '01',
    title: 'Объект — это<br /><em>живая картина.</em>',
    text: 'Фото и ключевые показатели собраны на одном экране, чтобы не искать информацию по чатам и заметкам.',
    points: ['✓ Фото объекта', '✓ Общая сумма', '✓ Статус работы'],
  },
  expenses: {
    number: '02',
    title: 'Каждый расход<br /><em>имеет значение.</em>',
  ...
  report: {
    number: '03',
    title: 'Отчёт готов<br /><em>к разговору.</em>',
    text: 'Общий итог, категории и PDF‑предпросмотр — в одном понятном экране для владельца и команды.',
